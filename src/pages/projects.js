    ...
    return (
        <div className="projects-perso-container ">
            ...
            <div className="links-card">
                <a href="https://github.com/tetedecactus/react_bootstrap_portfolio" aria-label="Liens vers projet">
            ...
            <div className="links-card">
                <a href="https://marketplace.visualstudio.com/search?term=TeteDeCactus&target=VSCode&category=All%20categories&sortBy=Relevance" aria-label="Liens vers projet">
                    <div className="project-card">
                        <img src={op_theme} width="150" height="130" alt="" loading="lazy" />
                        <div className="project-description">
            ...
            <div className="links-card">
                <a href="https://github.com/tetedecactus/framing_web_site" aria-label="Liens vers projet">
                    <div className="project-card">
                        <video width="150" autoPlay loop muted playsInline>
            ...
            <div className="links-card">
                <a href="https://github.com/tetedecactus/design_interieur_portfolio" aria-label="Liens vers projet">
                    <div className="project-card">
                        <video width="150" autoPlay loop muted playsInline>
            ...
            <div className="links-card">
                <a href="https://github.com/tetedecactus/react_tailwind_portfolio" aria-label="Liens vers projet">
                    <div className="project-card">
                        <video width="150" autoPlay loop muted playsInline>
                        ...
                        <div className="project-description">
                            ...
                            <p>Ce portfolio est mon deuxième et le premier à être déployé sur l'internet officiellement. J'ai voulu faire quelque chose de simple mais efficace. Je voulais <span>recréer les classNameiques</span> que l'on voit généralement dans un site web, c'est-à-dire, carrousel, formulaire de contact et changement de thème, de clair a sombre.</p>
                            <div>
                                {/* <!-- <p>NodeJs</p> --> */}
                                <p>React</p>
                                <p>Tailwind CSS</p>
...
const Projet42 = () => {
    return (
        <div className="projects-42-container">
            ...
            <div className="links-card">
                <a href="https://github.com/JOMST42/Transcendence" aria-label="Liens vers projet">
                    <div className="project-card">
                        <video width="150" autoPlay loop muted playsInline>
            ...
            <div className="links-card">
                <a href="https://github.com/tetedecactus/Fdf_42" aria-label="Liens vers projet">
                    <div className="project-card">
